    ...
    [4862],
    {
        ...
        72651: (e, t, n) => {
                    ...
                    function e(t, n, r) {
                        ...
                        !(function (e, t) {
                            ...
                            (this.handleTopDragEnterCapture = function (e) {
                                if (
                                    ((o.dragEnterTargetIds = []), o.enterLeaveCounter.enter(e.target) && !o.monitor.isDragging())
                                ) {
                            ...
                            (this.handleTopDragEnter = function (e) {
                                ...
                                ;((o.dragEnterTargetIds = []), o.monitor.isDragging()) &&
                                    ...
                                    t.some(function (e) {
                                        ...
                                        (e.preventDefault(),
                                        e.dataTransfer && (e.dataTransfer.dropEffect = o.getCurrentDropEffect())))
                            }),
                                        ...
                                        if (
                                            ...
                                            (!o.monitor.isDragging() &&
                                                (function (e, t, n, r, o) {
                                                    if (!o) return !1
                                                    for (
                                                        var i = (180 * Math.atan2(r - t, n - e)) / Math.PI + 180, s = 0;
                                                        s < o.length;
                                                        ++s
                                                    )
                                                        if (
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    return (
                                        ...
                                        function () {
                                            n.document &&
                                                (n.targetNodes.delete(e), n.removeEventListener(n.document.body, "move", r))
                                        }
                                    )
                                },
                            },
            ...
            const Cn = Tn("SET_NODES"),
                ...
                Xn = () => ({ type: Pn }),
                Zn = () => ({ type: An }),
                $n = (e, t, n, r, o) => ({ type: Ln, dropTarget: e, dropType: t, isHoveredLeft: n, boundBox: r, isLastChild: o }),
                Jn = () => ({ type: Mn }),
                Qn = (e) => ({ type: kn, ids: e }),
            ...
            const ur = (e) => e.nodes,
                ...
                Er = (0, lr.createSelector)([ur, Or], (e, t) => t.reduce((t, n) => [...t, ...Ir(e, (0, E.ensureDefined)(n))], []))
            function Ir(e, t) {
                const n = []
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        return this.handlerConnector
                                            ? l(this.handlerConnector.hooks, this.handlerMonitor, this.props)
                                            : {}
                                    },
                                },
                                {
                                                    ...
                                                    return (
                                                        ...
                                                        "undefined" != typeof requestAnimationFrame &&
                                                            requestAnimationFrame(function () {
                                                                var t
                                                                return null === (t = e.handlerConnector) || void 0 === t
                                                                    ? void 0
                                                                    : t.reconnect()
                                                            }),
                                                        (0, Ae.jsx)(
                                ...
                                ;(a = s > 20 && s <= 40),
                                    ...
                                    (c = i > 20 && i <= 40) || a
                                        ? "touch" === e.drag
                                            ...
                                            : n.startScroll(c ? -2 : 2)
                                        : (l || u) &&
                                          ("touch" === e.drag ? n.startScroll(l ? -10 : 10) : n.startScroll(l ? -5 : 5))
                            })(r.y, i.bottom, i.top)
                        },
                    },
                ...
                constructor(e) {
                    super(e),
                        ...
                        (this._renderChildren = (e) =>
                            o.createElement(Os, { isSmallTablet: e, viewModel: this.props.viewModel })),
