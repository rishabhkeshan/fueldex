                ...
                _updateImpl() {
                    ...
                    for (let e = 0; e < g.length; e++) {
                        ...
                        }
                        {
                            ...
                            n.setData(i),
                                n.setHitTest(
                                    new a.HitTestResult(a.HitTestResult.MOVEPOINT, void 0, { type: "h", index: g[e].index }),
                                ),
                                R.append(n)
                        }
                    }
                    for (let e = 0; e < x.length; e++) {
                        ...
                        }
                        {
                            ...
                            n.setData(i),
                                n.setHitTest(
                                    new a.HitTestResult(a.HitTestResult.MOVEPOINT, void 0, { type: "v", index: x[e].index }),
                                ),
                                R.append(n)
                        }
                    }
                        ...
                        if (null !== this._model.timeScale().visibleBarsStrictRange()) {
                            ...
                            for (var r = x ? x.index - e.index : 1, l = 1; l <= 11; l++) {
                                ...
                                if (_.visible.value()) {
                                    ...
                                    t.showLabels.value() &&
                                        ((g.text = _.coeff.value()), (g.y = this._source.priceScale().height())),
                                        this._levels.push(g)
                                }
                            }
                            var f = new h()
                ...
                _updateRenderer() {
                    if (!((w = this._points).length < 2)) {
                        ...
                        for (var p = this._levels.length - 1; p >= 0; p--) {
                            ...
                            var v = new l()
                            if (
                                (v.setData(f), v.setHitTest(new a(a.MOVEPOINT, null, g.index)), e.append(v), t.showCoeffs.value())
                            ) {
                                var x = new s(this, p)
                                e.append(x)
                            }
                ...
                _updateImpl(e, t) {
                    ...
                    if (!d) {
                        if (1 === this._points.length) {
                            ...
                            ;(e.data = 0),
                                (e.square = !0),
                                s.append(this.createLineAnchor({ points: [e], pointsCursorType: c }, 0))
                        }
                        0, (this._renderer = s)
                    }
                }
                    ...
                    if (((this._label = null), !(this._source.points().length < 2))) {
                        ...
                        if (this._source.properties().showPriceRange.value() && this._source.priceScale()) {
                            ...
                            T &&
                                ...
                                ((this._pipFormatter = new u(T.pricescale, T.minmov, T.type, T.minmove2)),
                    ...
                    if (!(this._points.length < 2)) {
                        ...
                        if (y)
                            for (p = 1; p < this._levels.length; p++) {
                                var S = this._levels[p - 1],
                                    P =
                                        ((e = new n(S.x, 0)),
                                        (t = new n(this._levels[p].x, this._source.priceScale().height())),
                                        {})
                                ;(P.points = [e, t]),
                        ...
                        for (p = 0; p < this._levels.length; p++) {
                            if (void 0 !== this._levels[p].text) {
                                ...
                                switch (
                                    ((M = "left" === M ? "right" : "right" === M ? "left" : "center"), l.vertLabelsAlign.value())
                                ) {
                                    case "top":
                ...
                _statLabelData() {
                    ...
                    if (_.showPriceRange.value() && this._source.priceScale()) {
                        ...
                        x &&
                            ...
                            ((this._pipFormatter = new u(x.pricescale, x.minmov, x.type, x.minmove2)),
                    ...
                    for (let d = 0; d < n.length; ++d) {
                        ...
                        if (h.subtract(e).length() <= i + a)
                            return new o.HitTestResult(Array.isArray(s) ? s[d] : s, {
                                pointIndex: h.data,
                                cursorType:
                                    null !== (t = null == r ? void 0 : r[d]) && void 0 !== t ? t : l.PaneCursorType.Default,
            ...
            class x {
                constructor(e, t, i) {
                    ;(this._fontSize = 0),
                        ...
                        (e.lines = this._lines =
                            null === e.text ? [] : (0, o.wordWrap)(e.text, this.fontStyle(), e.wordWrapWidth)),
