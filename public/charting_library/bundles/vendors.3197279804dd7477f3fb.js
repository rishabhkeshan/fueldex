;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [1216],
    {
        ...
        27490: (e, t, n) => {
            "use strict"
            n.r(t), n.d(t, { disable: () => l, enable: () => c, enabled: () => s, getAllFeatures: () => f, setEnabled: () => d })
            const r = JSON.parse(
                                    ...
                                    var l = function (e) {
                                        if (e.indexOf(a.formatSeparator) < 0) {
                                            ...
                                            return a.alwaysFormat
                                                ? a.format(o, void 0, n, d({}, r, t, { interpolationkey: e }))
                                                : o
                                        }
                                ...
                                value: function (e, t) {
                                    ...
                                    for (i.applyPostProcessor = !1, delete i.defaultValue; (n = this.nestingRegexp.exec(e)); ) {
                                        ...
                                        "string" != typeof r && (r = x(r)),
                                            r ||
                                                (this.logger.warn("missed to resolve ".concat(n[1], " for nesting ").concat(e)),
                                                (r = "")),
                                            c &&
                                ...
                                this.read(o, u, "read", void 0, void 0, function (r, i) {
                                    r &&
                                        ...
                                        !r &&
                                            i &&
                                            t.logger.log(
                                                "".concat(n, "loaded namespace ").concat(u, " for language ").concat(o),
                                                i,
                                            ),
                                        t.loaded(e, r, i)
                                })
                        ...
                        f(t, [
                            {
                                ...
                                value: function () {
                                    ...
                                    if (
                                        ...
                                        !t.defaultNS &&
                                            t.ns &&
                                            ("string" == typeof t.ns ? (t.defaultNS = t.ns) : (t.defaultNS = t.ns[0])),
                    ...
                    (u.manipulateListeners = function (e, t, n) {
                        ...
                        if ("object" != typeof t || t instanceof RegExp) for (r = n.length; r--; ) u.call(this, t, n[r])
                            ...
                            for (r in t)
                                t.hasOwnProperty(r) &&
                                    (o = t[r]) &&
                                    ("function" == typeof o ? u.call(this, r, o) : i.call(this, r, o))
                        return this
                    }),
