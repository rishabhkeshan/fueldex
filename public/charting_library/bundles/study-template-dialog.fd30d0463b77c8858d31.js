    ...
    [6631],
    {
        ...
        10342: (e, t, s) => {
                                ...
                                case n.Enter:
                                    ...
                                    t && (r && m ? this.setState(this._valueToQuery(m)) : (m = l)),
                                        void 0 !== m &&
                                            (this._close(),
                                            r || this._blur(),
                                            m !== s ? i && i(m) : this.setState(this._valueToQuery(m)))
                            }
                        }),
                ...
                render() {
                    return a.createElement(d.OutsideEvent, { handler: this._handleOutsideClick, click: !0 }, (e) =>
                        a.createElement(
                            "div",
                            {
                                className: l(m.autocomplete, { [m.opened]: this.state.isOpened }, "js-dialog-skip-escape"),
                                ref: e,
                            },
            ...
            const B = (0, o.t)("Save Indicator Template"),
                ...
                R = (0, o.t)("Selecting this option will set the {interval} interval on the chart when this template is applied"),
