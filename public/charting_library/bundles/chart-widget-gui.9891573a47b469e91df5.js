    ...
    [5093],
    {
        ...
        56786: (e, t, s) => {
            ...
            class Ae extends se {
                ...
                _getDisabledOnIntervalState() {
                    return (
                        !(!(0, pe.isStudy)(this._source) && !(0, pe.isStudyStub)(this._source)) &&
                            ...
                            for (const i of Object.keys(e)) {
                                ...
                                r.start.isFirstOrLastPoint ||
                                    (r.showStartForLastEntry =
                                        ((t = a), (s = e[o].entries), gt(t[t.length - 1], s[s.length - 1]))),
            ...
            class zt {
                ...
                async _getHtml(e) {
                    ...
                    return null !==
                        (i =
                            null === (s = null === (t = this._infoMaps.htmlMap) || void 0 === t ? void 0 : t.get(e)) ||
                            void 0 === s
                                ? void 0
            ...
            class Ss extends zt {
                ...
                _getShortTexts() {
                    ...
                    for (const i of t)
                        if (
                            (["DelayToRealtime", "DelayNoRealtime", ...es, "DelayWithoutMarketAgreement"].includes(i) &&
                                (s[i] = ls),
                            "EOD" === i && (s[i] = as),
                            "TickByTick" === i && (s[i] = os),
                            "BATSToRealtime" === i)
            ...
            class Hi {
                constructor(e, t) {
                    ...
                    ;(this.visibleWidgetsCount = new (a())(0)),
                        ...
                        (this._source = e),
                        (this._symbol =
                            null !== (i = null === (s = e.symbol()) || void 0 === s ? void 0 : s.spawn()) && void 0 !== i
                                ? i
                                : null),
                        (this._options = t),
